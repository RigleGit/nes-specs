...
a=[buf+2]+[buf+3h]+1
if a seed_start=630, data_start=817   ;snes/ntsc
...
& on Datel's Pro Action Replay. The hardware uses ROM patches (and thus
works more like Game Genie than Pro Action Replay). Codes are 8-digit hex
values in following format.
